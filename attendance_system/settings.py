...
SECRET_KEY = 'django-insecure-98z(dw2=r=wt&t^s1bub1+qopa87!%v9p+nm4880qss+-w%&dw'
...
# Database
# IMPORTANT: This is the database both Django and your face recognition script must use.
DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.sqlite3',
        # This path is the database file your Django app uses.
